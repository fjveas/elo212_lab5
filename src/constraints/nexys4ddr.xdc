...
#set_property -dict {PACKAGE_PIN N17 IOSTANDARD LVCMOS33} [get_ports {button[4]}]; # Center
...
## Pmod Header JA
#set_property -dict {PACKAGE_PIN C17 IOSTANDARD LVCMOS33 PULLUP TRUE} [get_ports {uart_rx}];
